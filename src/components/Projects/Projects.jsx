            ...
            <div key={id} className="project-box">
              ...
              <div className="project-content">
                ...
                <div className="project-link-wrapper">
                  <a href={live} target="_blank" className="project-link project-link-one"><BiLink className="project-icon" /></a>
                  <a href={code} target="_blank" className="project-link project-link-two"><BiLink className="project-icon" /></a>
                </div>
              </div>
            </div>
          )})
