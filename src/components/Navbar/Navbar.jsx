  ...
  return (
    <header className={scrollHeader}>
      ...
      <nav className="nav container">
        <a href="#home" className="nav-logo">IGEN<img src={logo} className="nav-logo-img" />TAN</a>
          <div className={active}>
            <ul onClick={removeNav} className="nav-list">
              ...
              <li className="nav-item"><a href="#blog" className="nav-link shadow">Blog</a></li>
            </ul>
            <div className="nav-footer">
              ...
              <div className="nav-footer-text-2"><p>igen-tan</p></div>
            </div>
